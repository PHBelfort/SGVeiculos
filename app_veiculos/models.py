...
class TipoDeVeiculo(models.Model):
    tipo = models.CharField('Tipo de veículo', max_length=20, help_text='Ex. Carro ou Moto')
    ...
    class Meta:
        ...
        verbose_name_plural = 'Tipos dos Veículos'

class MarcaDoVeiculo(models.Model):
    marca = models.CharField('Marca do Veículo', max_length=20, help_text='Ex. Nissan, Honda, Fiat')
